...
- [**1660**星][6mo] [C++][yegord/snowman](https://github.com/yegord/snowman) Snowman decompiler
...
- [**1506**星][2d] [Python][lifting-bits/mcsema](https://github.com/lifting-bits/mcsema) 将x86, amd64, aarch64二进制文件转换成LLVM字节码
